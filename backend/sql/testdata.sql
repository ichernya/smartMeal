DELETE FROM recipes;
INSERT INTO recipes(dishname, ingredients, ingredientAm, imageData, halal, kosher) VALUES ('Mushroom Poppers', '{"Beef":{"amount" : "20", "unit": "mushrooms"}, "Cheese":{"amount": "2", "unit": "cups"}, "Jalepeno": {"amount": "4", "unit": "jalepeno"}}', '3', '/test.png', 'true', 'true');
