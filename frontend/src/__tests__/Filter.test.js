...
/**
 */
test('check diet from homepage', async () => {
  ...
  fireEvent.mouseDown(screen.getByTestId('homeFilter'));

  fireEvent.click(screen.getByTestId('homevegan'));
  fireEvent.mouseDown(screen.getByTestId('homeFilters'));
});
