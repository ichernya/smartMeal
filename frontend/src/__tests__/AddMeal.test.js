...
test('add meal', async () => {
  ...
  act(() => {
    fireEvent.click(screen.getByTestId('addMeal'));
  });
  fireEvent.click(screen.getByText('US'));
  fireEvent.click(screen.getByTestId('removeImg'));
  fireEvent.click(screen.getByTestId('addIngredient'));
  fireEvent.change(screen.getByTestId('recipeName'),
    {target: {value: 'tofu'}});
  fireEvent.click(screen.getByTestId('addIngredient'));
  fireEvent.change(screen.getByTestId('ingredient'),
    {target: {value: 'tofu'}});
  ...
  fireEvent.mouseDown(screen.getByTestId('units'));
  fireEvent.click(screen.getByTestId('tsp'));
  fireEvent.click(screen.getByTestId('addIngredient'));

  fireEvent.mouseDown(screen.getByTestId('diets'));
  fireEvent.click(screen.getByTestId('Vegan'));

  // Add an already existing ingredient
  fireEvent.click(screen.getByTestId('addIngredient'));
  fireEvent.change(screen.getByTestId('recipeName'),
    {target: {value: 'tofu'}});
  fireEvent.click(screen.getByTestId('addIngredient'));
  ...
  // delete ingredient
  fireEvent.click(screen.getByTestId('deltofu'));
  ...
  const fileInput = screen.getByTestId('imgUpload');
  const fakeFile = new File(['hello'], 'hello.png', {type: 'image/png'});

  fireEvent.change(screen.getByTestId('imgUpload'),
